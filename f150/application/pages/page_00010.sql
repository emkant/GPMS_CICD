...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(27131295948421010)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(27131458739421011)
,p_plug_name=>'Access Denied'
,p_parent_plug_id=>wwv_flow_imp.id(27131295948421010)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(27131756162421014)
,p_plug_name=>'New'
,p_parent_plug_id=>wwv_flow_imp.id(27131295948421010)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(27131586215421013)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(27131756162421014)
