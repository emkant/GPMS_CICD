...
,p_javascript_code_onload=>'apex.util.getTopApex().jQuery(".trustModal .ui-dialog-title").text($v("P0_TRUST_LABEL"));'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_width=>'1000'
,p_dialog_css_classes=>'trustModal'
,p_protection_level=>'C'
,p_page_component_map=>'18'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38628113459266732)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(38628280971266732)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(38628520360267118)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(38631313135267123)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24985155197470724)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24985314505470725)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24985346913470726)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24985576525470728)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24985493069470727)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(24986617379470738)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(38631920837272451)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24986894171470741)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(35689333181707958)
,p_name=>'P16_CURRENCY'
,p_item_sequence=>100
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3279499503356451)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(38628113459266732)
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3279030262356448)
,p_event_id=>wwv_flow_imp.id(3279499503356451)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(38628113459266732)
