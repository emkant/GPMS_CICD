...
,p_step_template=>wwv_flow_imp.id(294376128784717091)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_page_component_map=>'16'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(294138397183113462)
,p_plug_name=>'GPMS Project Maint - Log In'
,p_icon_css_classes=>'fa-sign-in'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(294422138077717117)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(294140469213113469)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(294138397183113462)
,p_button_name=>'LOGIN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294138848066113464)
,p_name=>'P12_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(294138397183113462)
,p_prompt=>'Username'
...
,p_field_template=>wwv_flow_imp.id(294482661686717163)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294139180654113464)
,p_name=>'P12_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(294138397183113462)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294139609970113466)
,p_name=>'P12_REMEMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(294138397183113462)
...
,p_lov=>'.'||wwv_flow_imp.id(294511702247717186)||'.'
,p_label_alignment=>'RIGHT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294141306749113470)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294140885389113470)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294142150618113471)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294141741558113470)
,p_process_sequence=>10
