...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(286928086837957799)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(287179068184240083)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(286928086837957799)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16676843851673412)
,p_name=>'INV_BILL_FROM_DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(286928086837957799)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21729470077658041)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(27133718873421034)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287163382613877059)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287163435258877060)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287163511988877061)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287177961351240072)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287178023202240073)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287179316352240086)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(287179404088240087)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(312560152928379165)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(287179186554240084)
,p_name=>'InvoiceSubmitClick'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(287179068184240083)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2694001348079735)
,p_event_id=>wwv_flow_imp.id(287179186554240084)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(287179256243240085)
,p_event_id=>wwv_flow_imp.id(287179186554240084)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(287179732694240090)
,p_event_id=>wwv_flow_imp.id(287179186554240084)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(27133290474421030)
,p_event_id=>wwv_flow_imp.id(287179186554240084)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21729669418658043)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21729796316658044)
,p_event_id=>wwv_flow_imp.id(21729669418658043)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(27130141349420998)
,p_event_id=>wwv_flow_imp.id(21729669418658043)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21729952716658045)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21730058628658046)
,p_event_id=>wwv_flow_imp.id(21729952716658045)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21730111162658047)
,p_event_id=>wwv_flow_imp.id(21729952716658045)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16677092346673414)
,p_name=>'New'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16677184946673415)
,p_event_id=>wwv_flow_imp.id(16677092346673414)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15671803017406526)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4910972695536460)
