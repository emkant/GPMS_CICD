...
,p_javascript_code_onload=>'apex.util.getTopApex().jQuery(".retainerModal .ui-dialog-title").text($v("P0_RETAINER_LABEL"));'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_width=>'1000'
,p_dialog_css_classes=>'retainerModal'
,p_protection_level=>'C'
,p_page_component_map=>'18'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(27926837722029594)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(27927005234029594)
,p_name=>'Matter Credits'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27927244623029980)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27927699780029983)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27928132111029983)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27928494980029983)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27928930101029984)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27929253256029984)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27929652332029984)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(27930037398029985)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(27930645100035313)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24984388590470716)
,p_name=>'P15_CURRENCY'
,p_item_sequence=>90
,p_item_default=>'$'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(24984518962470717)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(27926837722029594)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(24984617612470718)
,p_event_id=>wwv_flow_imp.id(24984518962470717)
,p_event_result=>'TRUE'
