...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25775455617480291)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5236360890239354)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5235764609239353)
,p_plugin_attribute_id=>wwv_flow_imp.id(5236360890239354)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5235192256239352)
,p_plugin_attribute_id=>wwv_flow_imp.id(5236360890239354)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5234567587239351)
,p_plugin_attribute_id=>wwv_flow_imp.id(5236360890239354)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5234021532239350)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5236360890239354)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5233544123239350)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5233047562239350)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5232478426239349)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5232005183239349)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5231547171239348)
,p_plugin_attribute_id=>wwv_flow_imp.id(5232005183239349)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5230916467239348)
,p_plugin_attribute_id=>wwv_flow_imp.id(5232005183239349)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5230349158239348)
,p_plugin_attribute_id=>wwv_flow_imp.id(5232005183239349)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5229734545239347)
,p_plugin_attribute_id=>wwv_flow_imp.id(5232005183239349)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5229071312239346)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5228587638239345)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5227974026239345)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5227406474239344)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5226790420239344)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5226202966239343)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5225587306239343)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5224993462239342)
,p_plugin_attribute_id=>wwv_flow_imp.id(5229071312239346)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5224462744239342)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1825826553286594045)
,p_plugin_id=>wwv_flow_imp.id(25775455617480291)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
