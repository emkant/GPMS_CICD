...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25816914064480352)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5212373259239319)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5211870261239318)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5211366076239318)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5210912441239317)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5210415713239317)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5209906025239316)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5209418375239316)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5208941206239316)
,p_plugin_id=>wwv_flow_imp.id(25816914064480352)
,p_attribute_scope=>'COMPONENT'
