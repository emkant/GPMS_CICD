...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25847396857480383)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1922046287925832404)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1922045732913832403)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1665153669183558890)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5190018196239289)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5189488910239289)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5189027846239288)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5188491197239288)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5188058331239288)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5187528849239287)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5187025937239287)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5188058331239288)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1922046287925832404)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5186535108239287)
,p_plugin_attribute_id=>wwv_flow_imp.id(5187025937239287)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5185905769239286)
,p_plugin_attribute_id=>wwv_flow_imp.id(5187025937239287)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5185264197239286)
,p_plugin_attribute_id=>wwv_flow_imp.id(5187025937239287)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5184697205239285)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5187025937239287)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5184218127239285)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5183698140239285)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5183167711239284)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5182759177239283)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5182208537239283)
,p_plugin_attribute_id=>wwv_flow_imp.id(5182759177239283)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5181580208239283)
,p_plugin_attribute_id=>wwv_flow_imp.id(5182759177239283)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5181030843239282)
,p_plugin_attribute_id=>wwv_flow_imp.id(5182759177239283)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5180439634239282)
,p_plugin_attribute_id=>wwv_flow_imp.id(5182759177239283)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5179827700239281)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(5187528849239287)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1922045732913832403)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5179340669239281)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5178843331239281)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5178312929239280)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5177782054239280)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5177346297239280)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5176774353239279)
,p_plugin_attribute_id=>wwv_flow_imp.id(5177346297239280)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5176186450239279)
,p_plugin_attribute_id=>wwv_flow_imp.id(5177346297239280)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5175597063239278)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5175146221239278)
,p_plugin_attribute_id=>wwv_flow_imp.id(5175597063239278)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5174561449239277)
,p_plugin_attribute_id=>wwv_flow_imp.id(5175597063239278)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5173908623239277)
,p_plugin_attribute_id=>wwv_flow_imp.id(5175597063239278)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5173321724239277)
,p_plugin_attribute_id=>wwv_flow_imp.id(5175597063239278)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5172707195239276)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5172164674239276)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5171532798239275)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5170927789239273)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5170264873239272)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5169690930239272)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5169119925239271)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5168545265239271)
,p_plugin_attribute_id=>wwv_flow_imp.id(5172707195239276)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5167870643239271)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5167412668239270)
,p_plugin_attribute_id=>wwv_flow_imp.id(5167870643239271)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5166838667239270)
,p_plugin_attribute_id=>wwv_flow_imp.id(5167870643239271)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5166248139239270)
,p_plugin_attribute_id=>wwv_flow_imp.id(5167870643239271)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5165652934239269)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5165078956239269)
,p_plugin_attribute_id=>wwv_flow_imp.id(5165652934239269)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5164556771239268)
,p_plugin_attribute_id=>wwv_flow_imp.id(5165652934239269)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5163958393239268)
,p_plugin_attribute_id=>wwv_flow_imp.id(5165652934239269)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5163336305239268)
,p_plugin_attribute_id=>wwv_flow_imp.id(5165652934239269)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5162690142239267)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5162203860239267)
,p_plugin_attribute_id=>wwv_flow_imp.id(5162690142239267)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5161585745239266)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5161099779239266)
,p_plugin_attribute_id=>wwv_flow_imp.id(5161585745239266)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5160527696239266)
,p_plugin_attribute_id=>wwv_flow_imp.id(5161585745239266)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5159887396239265)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5159371761239264)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5158878977239263)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1665153669183558890)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5158420154239263)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5157887402239263)
,p_plugin_attribute_id=>wwv_flow_imp.id(5158420154239263)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5157268480239262)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5156769515239262)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1834299287076373697)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1834300546596377845)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1537347772180615267)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1820705658401966964)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1821384959132050068)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1834297352009328711)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1834298685399342568)
,p_plugin_id=>wwv_flow_imp.id(25847396857480383)
