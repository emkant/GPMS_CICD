...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294376128784717091)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5649859523239679)
,p_page_template_id=>wwv_flow_imp.id(294376128784717091)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5649343394239679)
,p_page_template_id=>wwv_flow_imp.id(294376128784717091)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5648766537239678)
,p_page_template_id=>wwv_flow_imp.id(294376128784717091)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5648275100239678)
,p_page_template_id=>wwv_flow_imp.id(294376128784717091)
,p_name=>'Body Footer'
