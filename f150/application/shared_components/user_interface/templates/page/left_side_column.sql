...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294370238984717086)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5668897141239690)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5668432194239690)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5667904727239690)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5667393625239689)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5666878269239689)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5666379569239689)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5665942265239689)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5665448992239689)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5664890832239688)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5664415602239688)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5663894913239688)
,p_page_template_id=>wwv_flow_imp.id(294370238984717086)
