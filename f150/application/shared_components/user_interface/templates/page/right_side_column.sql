...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294385520276717096)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5616133076239659)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5615592279239659)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5615129351239658)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5614565002239658)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5614098220239658)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5613621411239658)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5613110110239657)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5612585508239657)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5612082467239657)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5611594765239657)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5611097526239657)
,p_page_template_id=>wwv_flow_imp.id(294385520276717096)
