...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294388313342717097)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5606000462239653)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5605533007239653)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5605039650239653)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5604562241239653)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5604030515239652)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5603502115239652)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5603052635239652)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5602488698239652)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5602042138239652)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5601516356239651)
,p_page_template_id=>wwv_flow_imp.id(294388313342717097)
