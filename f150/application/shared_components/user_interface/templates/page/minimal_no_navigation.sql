...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294381461312717094)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5629756443239667)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5629232697239666)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5628717602239666)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5628245185239666)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5627670456239666)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5627245485239665)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5626664640239665)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5626201691239665)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5625729201239665)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5625197314239665)
,p_page_template_id=>wwv_flow_imp.id(294381461312717094)
