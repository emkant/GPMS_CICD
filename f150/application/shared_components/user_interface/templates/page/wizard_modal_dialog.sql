...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294390821597717099)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5599222656239650)
,p_page_template_id=>wwv_flow_imp.id(294390821597717099)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5598760058239650)
,p_page_template_id=>wwv_flow_imp.id(294390821597717099)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5598179710239649)
,p_page_template_id=>wwv_flow_imp.id(294390821597717099)
