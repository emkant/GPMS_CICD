...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29756748170939530)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5431938956239539)
,p_plug_template_id=>wwv_flow_imp.id(29756748170939530)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5431428849239539)
,p_plug_template_id=>wwv_flow_imp.id(29756748170939530)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5430929271239539)
,p_plug_template_id=>wwv_flow_imp.id(29756748170939530)
,p_name=>'Button Start'
