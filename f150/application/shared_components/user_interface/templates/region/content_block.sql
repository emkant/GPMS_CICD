...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294411783744717112)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5506879465239585)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5506367175239585)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5505953125239585)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5505411192239585)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5504889925239584)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5504435496239584)
,p_plug_template_id=>wwv_flow_imp.id(294411783744717112)
,p_name=>'Sub Regions'
