...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29735495298939517)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5461737245239557)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5461256741239557)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5460706887239557)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5460254750239556)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5459690806239556)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5459165546239556)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5458741700239556)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5458241666239556)
,p_plug_template_id=>wwv_flow_imp.id(29735495298939517)
,p_name=>'Sub Regions'
