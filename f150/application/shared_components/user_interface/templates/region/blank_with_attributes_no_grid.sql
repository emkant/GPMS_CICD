...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294396186724717101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5578830634239630)
,p_plug_template_id=>wwv_flow_imp.id(294396186724717101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5578274448239630)
,p_plug_template_id=>wwv_flow_imp.id(294396186724717101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5577788868239630)
,p_plug_template_id=>wwv_flow_imp.id(294396186724717101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5577342321239630)
,p_plug_template_id=>wwv_flow_imp.id(294396186724717101)
,p_name=>'Sub Regions'
