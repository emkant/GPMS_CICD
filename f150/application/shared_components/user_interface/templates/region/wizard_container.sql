...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294433761718717138)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5364329586239499)
,p_plug_template_id=>wwv_flow_imp.id(294433761718717138)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5363805498239498)
,p_plug_template_id=>wwv_flow_imp.id(294433761718717138)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5363351647239498)
,p_plug_template_id=>wwv_flow_imp.id(294433761718717138)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5362800412239498)
,p_plug_template_id=>wwv_flow_imp.id(294433761718717138)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5362285918239498)
,p_plug_template_id=>wwv_flow_imp.id(294433761718717138)
