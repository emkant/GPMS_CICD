...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294418256863717115)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5449389301239550)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5448883085239550)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5448390568239549)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5447896598239549)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5447385353239549)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5446879272239549)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5446441632239548)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5445913520239548)
,p_plug_template_id=>wwv_flow_imp.id(294418256863717115)
,p_name=>'Sub Regions'
