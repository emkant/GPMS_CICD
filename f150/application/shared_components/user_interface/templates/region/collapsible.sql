...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294406416430717109)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5532031571239601)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5531532811239601)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5530994685239601)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5530537549239600)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5529989124239600)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5529537351239600)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5529027534239600)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5528495435239599)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5527980871239599)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5527464963239599)
,p_plug_template_id=>wwv_flow_imp.id(294406416430717109)
,p_name=>'Sub Regions'
