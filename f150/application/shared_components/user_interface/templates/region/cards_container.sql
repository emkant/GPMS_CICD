...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29760984381939533)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5564230369239622)
,p_plug_template_id=>wwv_flow_imp.id(29760984381939533)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5563704911239622)
,p_plug_template_id=>wwv_flow_imp.id(29760984381939533)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5563228342239621)
,p_plug_template_id=>wwv_flow_imp.id(29760984381939533)
,p_name=>'Sub Regions'
