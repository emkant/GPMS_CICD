...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294395967304717101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5582671962239633)
,p_plug_template_id=>wwv_flow_imp.id(294395967304717101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5582166241239632)
,p_plug_template_id=>wwv_flow_imp.id(294395967304717101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5581672474239632)
,p_plug_template_id=>wwv_flow_imp.id(294395967304717101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5581241920239632)
,p_plug_template_id=>wwv_flow_imp.id(294395967304717101)
,p_name=>'Sub Regions'
