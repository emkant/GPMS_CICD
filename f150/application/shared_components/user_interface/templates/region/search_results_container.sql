...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29752381474939528)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5419390042239531)
,p_plug_template_id=>wwv_flow_imp.id(29752381474939528)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5418942130239531)
,p_plug_template_id=>wwv_flow_imp.id(29752381474939528)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5418366497239531)
,p_plug_template_id=>wwv_flow_imp.id(29752381474939528)
,p_name=>'Sub Regions'
