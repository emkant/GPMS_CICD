...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294422138077717117)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5425083912239535)
,p_plug_template_id=>wwv_flow_imp.id(294422138077717117)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5424725756239535)
,p_plug_template_id=>wwv_flow_imp.id(294422138077717117)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5424203740239534)
,p_plug_template_id=>wwv_flow_imp.id(294422138077717117)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5423734590239534)
,p_plug_template_id=>wwv_flow_imp.id(294422138077717117)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5423190369239534)
,p_plug_template_id=>wwv_flow_imp.id(294422138077717117)
,p_name=>'Sub Regions'
