...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294421485007717116)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5436474636239542)
,p_plug_template_id=>wwv_flow_imp.id(294421485007717116)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5436008902239542)
,p_plug_template_id=>wwv_flow_imp.id(294421485007717116)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5435520377239541)
,p_plug_template_id=>wwv_flow_imp.id(294421485007717116)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5435020795239541)
,p_plug_template_id=>wwv_flow_imp.id(294421485007717116)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5434537743239541)
,p_plug_template_id=>wwv_flow_imp.id(294421485007717116)
,p_name=>'Sub Regions'
