...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29743501607939523)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5488669120239574)
,p_plug_template_id=>wwv_flow_imp.id(29743501607939523)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5488210357239573)
,p_plug_template_id=>wwv_flow_imp.id(29743501607939523)
,p_name=>'Sub Regions'
