...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294392307839717099)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5594381318239641)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5593915619239641)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5593456485239640)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5592939354239640)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5592431926239640)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5591916941239640)
,p_plug_template_id=>wwv_flow_imp.id(294392307839717099)
,p_name=>'Sub Regions'
