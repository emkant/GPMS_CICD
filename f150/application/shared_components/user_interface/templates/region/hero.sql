...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294413787026717113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5496170272239578)
,p_plug_template_id=>wwv_flow_imp.id(294413787026717113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5495692406239578)
,p_plug_template_id=>wwv_flow_imp.id(294413787026717113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5495250265239578)
,p_plug_template_id=>wwv_flow_imp.id(294413787026717113)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5494751937239577)
,p_plug_template_id=>wwv_flow_imp.id(294413787026717113)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5494219962239577)
,p_plug_template_id=>wwv_flow_imp.id(294413787026717113)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
