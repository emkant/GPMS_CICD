...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294415908052717114)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5473160603239564)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5472631271239563)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5472087019239563)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5471605901239563)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5471107961239563)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5470563232239562)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5470118555239562)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5469638207239562)
,p_plug_template_id=>wwv_flow_imp.id(294415908052717114)
,p_name=>'Sub Regions'
