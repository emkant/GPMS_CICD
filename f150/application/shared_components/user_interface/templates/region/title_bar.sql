...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294432830406717122)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5375529792239505)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5375031715239504)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5374550418239504)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5373972711239504)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5373509539239504)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5372980979239503)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5372549670239503)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5371991954239503)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5371503884239503)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5370979531239502)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5370530356239502)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5370022992239502)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5369489775239502)
,p_plug_template_id=>wwv_flow_imp.id(294432830406717122)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
