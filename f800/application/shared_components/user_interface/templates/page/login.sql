...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(308360991908310788)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8335003600354018)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8335519729354018)
,p_page_template_id=>wwv_flow_imp.id(308360991908310788)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8336096586354019)
,p_page_template_id=>wwv_flow_imp.id(308360991908310788)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8336588023354019)
,p_page_template_id=>wwv_flow_imp.id(308360991908310788)
,p_name=>'Body Footer'
