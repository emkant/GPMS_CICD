...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(308355102108310783)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8315965982354007)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8316430929354007)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8316958396354007)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8317469498354008)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8317984854354008)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8318483554354008)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8318920858354008)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8319414131354008)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8319972291354009)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8320447521354009)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8320968210354009)
,p_page_template_id=>wwv_flow_imp.id(308355102108310783)
