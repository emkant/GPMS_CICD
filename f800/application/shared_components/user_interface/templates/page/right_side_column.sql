...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(308370383400310793)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8368730047354038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8369270844354038)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8369733772354039)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8370298121354039)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8370764903354039)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8371241712354039)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8371753013354040)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8372277615354040)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8372780656354040)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8373268358354040)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8373765597354040)
,p_page_template_id=>wwv_flow_imp.id(308370383400310793)
