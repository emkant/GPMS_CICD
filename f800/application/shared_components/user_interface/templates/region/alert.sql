...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308377170963310796)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8390481805354056)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8390947504354056)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8391406638354057)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8391923769354057)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8392431197354057)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8392946182354057)
,p_plug_template_id=>wwv_flow_imp.id(308377170963310796)
,p_name=>'Sub Regions'
