...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308380830428310798)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8402191161354064)
,p_plug_template_id=>wwv_flow_imp.id(308380830428310798)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8402696882354065)
,p_plug_template_id=>wwv_flow_imp.id(308380830428310798)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8403190649354065)
,p_plug_template_id=>wwv_flow_imp.id(308380830428310798)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8403621203354065)
,p_plug_template_id=>wwv_flow_imp.id(308380830428310798)
,p_name=>'Sub Regions'
