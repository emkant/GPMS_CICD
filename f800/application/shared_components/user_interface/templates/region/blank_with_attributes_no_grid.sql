...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308381049848310798)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8406032489354067)
,p_plug_template_id=>wwv_flow_imp.id(308381049848310798)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8406588675354067)
,p_plug_template_id=>wwv_flow_imp.id(308381049848310798)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8407074255354067)
,p_plug_template_id=>wwv_flow_imp.id(308381049848310798)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8407520802354067)
,p_plug_template_id=>wwv_flow_imp.id(308381049848310798)
,p_name=>'Sub Regions'
