...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308398650150310810)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8488692851354119)
,p_plug_template_id=>wwv_flow_imp.id(308398650150310810)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8489170717354119)
,p_plug_template_id=>wwv_flow_imp.id(308398650150310810)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8489612858354119)
,p_plug_template_id=>wwv_flow_imp.id(308398650150310810)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8490111186354120)
,p_plug_template_id=>wwv_flow_imp.id(308398650150310810)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8490643161354120)
,p_plug_template_id=>wwv_flow_imp.id(308398650150310810)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
