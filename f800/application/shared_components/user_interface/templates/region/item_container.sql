...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43741611294533227)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8552924167354158)
,p_plug_template_id=>wwv_flow_imp.id(43741611294533227)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8553434274354158)
,p_plug_template_id=>wwv_flow_imp.id(43741611294533227)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8553933852354158)
,p_plug_template_id=>wwv_flow_imp.id(43741611294533227)
,p_name=>'Button Start'
