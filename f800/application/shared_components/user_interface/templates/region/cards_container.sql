...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43745847505533230)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8420632754354075)
,p_plug_template_id=>wwv_flow_imp.id(43745847505533230)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8421158212354075)
,p_plug_template_id=>wwv_flow_imp.id(43745847505533230)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8421634781354076)
,p_plug_template_id=>wwv_flow_imp.id(43745847505533230)
,p_name=>'Sub Regions'
