...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308406348131310813)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8548388487354155)
,p_plug_template_id=>wwv_flow_imp.id(308406348131310813)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8548854221354155)
,p_plug_template_id=>wwv_flow_imp.id(308406348131310813)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8549342746354156)
,p_plug_template_id=>wwv_flow_imp.id(308406348131310813)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8549842328354156)
,p_plug_template_id=>wwv_flow_imp.id(308406348131310813)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8550325380354156)
,p_plug_template_id=>wwv_flow_imp.id(308406348131310813)
,p_name=>'Sub Regions'
