...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308407001201310814)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8559779211354162)
,p_plug_template_id=>wwv_flow_imp.id(308407001201310814)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8560137367354162)
,p_plug_template_id=>wwv_flow_imp.id(308407001201310814)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8560659383354163)
,p_plug_template_id=>wwv_flow_imp.id(308407001201310814)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8561128533354163)
,p_plug_template_id=>wwv_flow_imp.id(308407001201310814)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8561672754354163)
,p_plug_template_id=>wwv_flow_imp.id(308407001201310814)
,p_name=>'Sub Regions'
