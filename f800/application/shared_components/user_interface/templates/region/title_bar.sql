...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308417693530310819)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8609333331354192)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8609831408354193)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8610312705354193)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8610890412354193)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8611353584354193)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8611882144354194)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8612313453354194)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8612871169354194)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8613359239354194)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8613883592354195)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8614332767354195)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8614840131354195)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8615373348354195)
,p_plug_template_id=>wwv_flow_imp.id(308417693530310819)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
