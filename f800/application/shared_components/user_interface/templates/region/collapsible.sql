...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308391279554310806)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8452831552354096)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8453330312354096)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8453868438354096)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8454325574354097)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8454873999354097)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8455325772354097)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8455835589354097)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8456367688354098)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8456882252354098)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8457398160354098)
,p_plug_template_id=>wwv_flow_imp.id(308391279554310806)
,p_name=>'Sub Regions'
