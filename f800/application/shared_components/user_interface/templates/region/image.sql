...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43728364731533220)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8496194003354123)
,p_plug_template_id=>wwv_flow_imp.id(43728364731533220)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8496652766354124)
,p_plug_template_id=>wwv_flow_imp.id(43728364731533220)
,p_name=>'Sub Regions'
