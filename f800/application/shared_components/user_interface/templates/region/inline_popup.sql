...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308403119987310812)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8535473822354147)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8535980038354147)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8536472555354148)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8536966525354148)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8537477770354148)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8537983851354148)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8538421491354149)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8538949603354149)
,p_plug_template_id=>wwv_flow_imp.id(308403119987310812)
,p_name=>'Sub Regions'
