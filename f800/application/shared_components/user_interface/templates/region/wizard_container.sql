...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308418624842310835)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8620533537354198)
,p_plug_template_id=>wwv_flow_imp.id(308418624842310835)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8621057625354199)
,p_plug_template_id=>wwv_flow_imp.id(308418624842310835)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8621511476354199)
,p_plug_template_id=>wwv_flow_imp.id(308418624842310835)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8622062711354199)
,p_plug_template_id=>wwv_flow_imp.id(308418624842310835)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8622577205354199)
,p_plug_template_id=>wwv_flow_imp.id(308418624842310835)
