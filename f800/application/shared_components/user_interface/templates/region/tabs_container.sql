...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308415079754310818)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8599598650354187)
,p_plug_template_id=>wwv_flow_imp.id(308415079754310818)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8600030258354187)
,p_plug_template_id=>wwv_flow_imp.id(308415079754310818)
,p_name=>'Tabs'
