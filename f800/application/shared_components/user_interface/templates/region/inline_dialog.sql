...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308400771176310811)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8511702520354133)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8512231852354134)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8512776104354134)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8513257222354134)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8513755162354134)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8514299891354135)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8514744568354135)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8515224916354135)
,p_plug_template_id=>wwv_flow_imp.id(308400771176310811)
,p_name=>'Sub Regions'
