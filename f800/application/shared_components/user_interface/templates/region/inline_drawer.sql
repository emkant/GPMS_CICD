...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43720358422533214)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8523125878354140)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8523606382354140)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8524156236354140)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8524608373354141)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8525172317354141)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8525697577354141)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8526121423354141)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8526621457354141)
,p_plug_template_id=>wwv_flow_imp.id(43720358422533214)
,p_name=>'Sub Regions'
