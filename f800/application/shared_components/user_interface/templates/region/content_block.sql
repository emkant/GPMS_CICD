...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(308396646868310809)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8477983658354112)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8478495948354112)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8478909998354112)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8479451931354112)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8479973198354113)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8480427627354113)
,p_plug_template_id=>wwv_flow_imp.id(308396646868310809)
,p_name=>'Sub Regions'
