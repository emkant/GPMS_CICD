...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(39801777188074049)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8772489864354378)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8772992862354379)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8773497047354379)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8773950682354380)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8774447410354380)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8774957098354381)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8775444748354381)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8775921917354381)
,p_plugin_id=>wwv_flow_imp.id(39801777188074049)
,p_attribute_scope=>'COMPONENT'
