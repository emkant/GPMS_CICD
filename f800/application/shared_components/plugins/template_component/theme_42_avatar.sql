...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(39760318741073988)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8748502233354343)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8749098514354344)
,p_plugin_attribute_id=>wwv_flow_imp.id(8748502233354343)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8749670867354345)
,p_plugin_attribute_id=>wwv_flow_imp.id(8748502233354343)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8750295536354346)
,p_plugin_attribute_id=>wwv_flow_imp.id(8748502233354343)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8750841591354347)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8748502233354343)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8751319000354347)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8751815561354347)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8752384697354348)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8752857940354348)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8753315952354349)
,p_plugin_attribute_id=>wwv_flow_imp.id(8752857940354348)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8753946656354349)
,p_plugin_attribute_id=>wwv_flow_imp.id(8752857940354348)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8754513965354349)
,p_plugin_attribute_id=>wwv_flow_imp.id(8752857940354348)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8755128578354350)
,p_plugin_attribute_id=>wwv_flow_imp.id(8752857940354348)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8755791811354351)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8756275485354352)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8756889097354352)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8757456649354353)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8758072703354353)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8758660157354354)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8759275817354354)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8759869661354355)
,p_plugin_attribute_id=>wwv_flow_imp.id(8755791811354351)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8760400379354355)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1839811416410187742)
,p_plugin_id=>wwv_flow_imp.id(39760318741073988)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
