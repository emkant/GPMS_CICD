...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(50668071260910595)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(50669464331910609)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29657569415000232)
,p_name=>'P7_FEES_DUMMY'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31666419530480630)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31666680910482726)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41119286572014738)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41119393081014739)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50668191692910596)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50668203569910597)
,p_name=>'P7_LINES'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_prompt=>'Lines'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50668378352910598)
,p_name=>'P7_HOURS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_prompt=>'Hours'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50668798368910602)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50668972494910604)
,p_name=>'P7_JOB_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_prompt=>'Job Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50669782080910612)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(55461313308944385)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(55461462253944386)
,p_name=>'P7_FEES'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(50668071260910595)
,p_prompt=>'Fees'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(55461544145944387)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(55461616315944388)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(30661791141267110)
...
,p_always_execute=>'Y'
,p_when_button_pressed=>wwv_flow_imp.id(50669464331910609)
,p_associated_item=>wwv_flow_imp.id(31666419530480630)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(50669634999910611)
...
,p_process_when_button_id=>wwv_flow_imp.id(50669464331910609)
,p_process_success_message=>'Adjustment Successful!!'
,p_internal_uid=>22699908752723217
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(50881642792902287)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(50668873652910603)
,p_process_sequence=>10
