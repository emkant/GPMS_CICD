...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(41115842151014704)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41115930677014705)
,p_name=>'P9_JWT_BASE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(41115842151014704)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41116098555014706)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41116852731014714)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41116965801014715)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41117089184014716)
,p_name=>'P9_SOURCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(41115842151014704)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(41117138806014717)
,p_name=>'P9_URL'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(43133690327386651)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(43134043286386659)
,p_event_id=>wwv_flow_imp.id(43133690327386651)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41117364362014719)
,p_event_id=>wwv_flow_imp.id(43133690327386651)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(41115755628014703)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(43134625976388042)
