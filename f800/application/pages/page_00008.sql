...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(360831060068770628)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(301984746283380220)
,p_plug_name=>'Spell Checker Results'
,p_region_name=>'spell_check_region'
,p_parent_plug_id=>wwv_flow_imp.id(360831060068770628)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(62920688724525640)
,p_name=>'EXP_ITEM_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(62920798073525641)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(301987951951380252)
,p_name=>'ERROR_WORD'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(301988158930380254)
,p_name=>'SUGGESTED'
,p_source_type=>'NONE'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(304892885558231214)
,p_name=>'NARRATIVE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(304896351571231249)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(305489175937615558)
,p_name=>'IGNORE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(301987776390380250)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(304488154677472304)
,p_interactive_grid_id=>wwv_flow_imp.id(301987776390380250)
,p_static_id=>'492148'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(304488361906472304)
,p_report_id=>wwv_flow_imp.id(304488154677472304)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52047380618484337)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(62920688724525640)
,p_is_visible=>true
,p_is_frozen=>false
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52048781499484341)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(62920798073525641)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(304489836763472316)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(301987951951380252)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>121
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(304493756668509083)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(301988158930380254)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>149
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(305100808631577947)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(304892885558231214)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>179
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(305184628059802124)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(304896351571231249)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>59
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(305987212118574908)
,p_view_id=>wwv_flow_imp.id(304488361906472304)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(305489175937615558)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>57
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(301987491333380247)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52049744735410052)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(301987491333380247)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52050107631410052)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52049015174410051)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(301984746283380220)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52048644228410051)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52048260795410049)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(52044039383410022)
,p_name=>'P8_SPELL_RECORDS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(360831060068770628)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(52050585783410052)
,p_name=>'P8_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(301987491333380247)
,p_prompt=>'Find'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(52050974921410053)
,p_name=>'P8_REPLACE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(301987491333380247)
,p_prompt=>'Replace'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(51757142226293624)
,p_name=>'Click on Spell Check Button'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(52049015174410051)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(51757231792293625)
,p_event_id=>wwv_flow_imp.id(51757142226293624)
,p_event_result=>'TRUE'
