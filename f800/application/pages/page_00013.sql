...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20485023914765310)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20486195157765321)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16679411201673438)
,p_plug_name=>'Edit Bill Lines Grid'
,p_region_name=>'ig'
,p_parent_plug_id=>wwv_flow_imp.id(20486195157765321)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484117257765301)
,p_name=>'DESCRIPTION'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484206703765302)
,p_name=>'FEES'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484393571765303)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484678969765306)
,p_name=>'SNO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484706627765307)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484866762765308)
,p_name=>'PROJECT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20484968183765309)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20485658576765316)
,p_name=>'SESSION_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(16679898507673442)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(20470217356721953)
,p_interactive_grid_id=>wwv_flow_imp.id(16679898507673442)
,p_static_id=>'204703'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(20470438118721954)
,p_report_id=>wwv_flow_imp.id(20470217356721953)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20490172879765481)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(20484117257765301)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>680
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20491094087765485)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(20484206703765302)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>160
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20494093068966522)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(20484393571765303)
,p_is_visible=>true
,p_is_frozen=>true
,p_width=>50
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20498429131089711)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(20484678969765306)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20499358890089714)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(20484706627765307)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20500209549089717)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(20484866762765308)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20501189846089720)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(20484968183765309)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(20864724752907791)
,p_view_id=>wwv_flow_imp.id(20470438118721954)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(20485658576765316)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20487931298765339)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#:margin-top-none'
,p_plug_template=>wwv_flow_imp.id(308381049848310798)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20488533817765345)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20488468690765344)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(20488533817765345)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20486020514765320)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(20486195157765321)
,p_button_name=>'SAVE'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(308468966713310861)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16679587196673439)
,p_name=>'P13_PROJECT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16679411201673438)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16679611220673440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16679759541673441)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20485135596765311)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20486622068765326)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20486970075765329)
,p_name=>'P13_ROLLING_TOTAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(20487931298765339)
,p_prompt=>'Total'
,p_format_mask=>'999G999G999G999G990D00'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20486204687765322)
,p_name=>'On Click of SAVE'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(20486020514765320)
,p_bind_type=>'live'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20486328880765323)
,p_event_id=>wwv_flow_imp.id(20486204687765322)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20486719113765327)
,p_name=>'New'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(16679411201673438)
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20486812272765328)
,p_event_id=>wwv_flow_imp.id(20486719113765327)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(16679411201673438)
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20487029204765330)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20487109039765331)
,p_event_id=>wwv_flow_imp.id(20487029204765330)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20488103287765341)
,p_event_id=>wwv_flow_imp.id(20487029204765330)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20488341201765343)
,p_event_id=>wwv_flow_imp.id(20487029204765330)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20488654470765346)
,p_name=>'Get the Tasks and Fees'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(20488468690765344)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20488758448765347)
,p_event_id=>wwv_flow_imp.id(20488654470765346)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9757179990138008)
,p_event_id=>wwv_flow_imp.id(20488654470765346)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20488818508765348)
,p_event_id=>wwv_flow_imp.id(20488654470765346)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9757058848138007)
,p_event_id=>wwv_flow_imp.id(20488654470765346)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(20484518409765305)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(16679411201673438)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(20485786510765317)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(20485266414765312)
,p_process_sequence=>20
