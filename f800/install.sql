...
@@application/shared_components/files/prebillingadjustments_min_css.sql
@@application/shared_components/files/prebillingadjustments_min_js.sql
@@application/shared_components/files/typo_min_js.sql
@@application/shared_components/files/typo_js.sql
@@application/shared_components/files/dictionaries_zip.sql
@@application/shared_components/files/prebillingadjustments_css.sql
@@application/shared_components/files/prebillingadjustments_js.sql
@@application/shared_components/files/en_us_aff.sql
@@application/shared_components/files/en_us_dic.sql
@@application/shared_components/files/mcmillan_logo_png.sql
@@application/shared_components/files/mcmillan_logo_sm_png.sql
@@application/shared_components/files/gpmslogo_jpg.sql
@@application/shared_components/files/harneys_jpg.sql
...
@@application/shared_components/logic/application_items/g_currency.sql
@@application/shared_components/logic/application_items/g_hide_project.sql
@@application/shared_components/logic/application_items/g_jwt_base.sql
@@application/shared_components/logic/application_items/g_saas_access_token.sql
@@application/shared_components/logic/application_items/g_saas_access_url.sql
@@application/shared_components/logic/application_items/g_saas_preferred_name.sql
@@application/shared_components/logic/application_items/g_saas_user.sql
@@application/shared_components/logic/application_items/g_timestamp.sql
@@application/shared_components/logic/application_items/g_token_available.sql
@@application/shared_components/logic/application_items/g_token_duration.sql
@@application/shared_components/logic/application_computations/g_saas_access_url.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/spell_check_suggested_words.sql
...
@@application/shared_components/automations/get_all_projects.sql
...
@@application/shared_components/plugins/item_type/com_stefandobre_progressbar.sql
